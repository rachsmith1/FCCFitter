...
#python python/limitplot.py -f "Outputs/cms/Zprime/ee/Zprime_ee_*TeV/Limits/*" -n "Zprime_ee_cms" -p "Z\' \rightarrow ee~~CMS"
#python python/limitplot.py -f "Outputs/cms/Zprime/mumu/Zprime_mumu_*TeV/Limits/*" -n "Zprime_mumu_cms" -p "Z\' \rightarrow \mu\mu~~CMS"
...
python python/limitplot.py -f "Outputs/fcc_v01/Zprime/tt/Zprime_tt_*TeV/Limits/*" -n "Zprime_tt_fcc_v01" -p "Z\' \rightarrow ttbar" -t "ttbar"
